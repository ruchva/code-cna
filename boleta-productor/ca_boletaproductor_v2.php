...
{	
	...
	echo $docID = '02';	
	echo $datosArray_p1=$obj->ca_busqueda_doc_id_p1($docID);
	echo $datosArray_p2=$obj->ca_busqueda_doc_id_p2($docID);
	/*
...
?>
<?php 
if (isset($_POST["botPress"]) && ($_POST["botPress"]=="")){
    $docID  = '02';//'02-02-01-01-001';
	//$docID  = $_POST['DOC_ID'];
...
<label><strong>BOLETA DEL PRODUCTOR</strong></label> Pregunta: <input class="cuarenta_px" name="txtPregunta" id="txtPregunta" type="text" autofocus="autofocus"/>
...
<input type="button" name="0" id="0" value="Encabezado" onKeyDown="A(event,null);" onclick="enviar(this.form,'p0')"  />
    <table style="border: medium none ; width: 100%;" align="top">
                ...
                <div id="p0" style="display:<?php echo $p0; ?>">
                    ...
                    <table>
                        <tr>
							...
							<td><input name="btnInsertar" id="btnInsertar" value="Insertar" type="button" onKeyDown="A(event,null);" onclick="enviar(this.form,'insertar')"/></td>
                        </tr>
                    </table>
					<input type="hidden" name="MM_update" value="form" />
                </div>
        ...
        <tr>
            <td>
                <div id="p23" style="display:<?php echo $p23; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p24" style="display:<?php echo $p24; ?>; ">
                    <table>          
                        <tr>
        ...
        <tr>
            <td>
                <div id="p25" style="display:<?php echo $p25; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p26" style="display:<?php echo $p26; ?> ; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p27" style="display:<?php echo $p27; ?> ; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p28" style="display:<?php echo $p28; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p29" style="display:<?php echo $p29; ?>; ">
                    <table>          
                        <tr>
        ...
        <tr>
            <td>
                <div id="p30" style="display:<?php echo $p30; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p31" style="display:<?php echo $p31; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p32" style="display:<?php echo $p32; ?>; ">
                    <table>          
                        <tr>
        ...
        <tr>
            <td>
                <div id="p33" style="display:<?php echo $p33; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p34" style="display:<?php echo $p34; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p35" style="display:<?php echo $p35; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p36" style="display:<?php echo $p36; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p37" style="display:<?php echo $p37; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p38" style="display:<?php echo $p38; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p39" style="display:<?php echo $p39; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p40" style="display:<?php echo $p40; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p41" style="display:<?php echo $p41; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p42" style="display:<?php echo $p42; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p43" style="display:<?php echo $p43; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p44" style="display:<?php echo $p44; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p45" style="display:<?php echo $p45; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p46" style="display:<?php echo $p46; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p47" style="display:<?php echo $p47; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p48" style="display:<?php echo $p48; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p49" style="display:<?php echo $p49; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p50" style="display:<?php echo $p50; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p51" style="display:<?php echo $p51; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p52" style="display:<?php echo $p52; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p53" style="display:<?php echo $p53; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p54" style="display:<?php echo $p54; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p55" style="display:<?php echo $p55; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p56" style="display:<?php echo $p56; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p57" style="display:<?php echo $p57; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p58" style="display:<?php echo $p58; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p59" style="display:<?php echo $p59; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p60" style="display:<?php echo $p60; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p61" style="display:<?php echo $p61; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p62" style="display:<?php echo $p62; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p63" style="display:<?php echo $p63; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p64" style="display:<?php echo $p64; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p65" style="display:<?php echo $p65; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p66" style="display:<?php echo $p66; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p67" style="display:<?php echo $p67; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p68" style="display:<?php echo $p68; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p69" style="display:<?php echo $p69; ?>; ">
                    <table>
        ...
        <tr>
            <td>
                <div id="p70" style="display:<?php echo $p70; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p71" style="display:<?php echo $p71; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p72" style="display:<?php echo $p72; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p73" style="display:<?php echo $p73; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p74" style="display:<?php echo $p74; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p75" style="display:<?php echo $p75; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p76" style="display:<?php echo $p76; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p77" style="display:<?php echo $p77; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p78" style="display:<?php echo $p78; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p79" style="display:<?php echo $p79; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p80" style="display:<?php echo $p80; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p81" style="display:<?php echo $p81; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p82" style="display:<?php echo $p82; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p83" style="display:<?php echo $p83; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p84" style="display:<?php echo $p84; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p85" style="display:<?php echo $p85; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p86" style="display:<?php echo $p86; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p87" style="display:<?php echo $p87; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p88" style="display:<?php echo $p88; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p89" style="display:<?php echo $p89; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p90" style="display:<?php echo $p90; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p91" style="display:<?php echo $p91; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p92" style="display:<?php echo $p92; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p93" style="display:<?php echo $p93; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p94" style="display:<?php echo $p94; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p95" style="display:<?php echo $p95; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p96" style="display:<?php echo $p96; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p97" style="display:<?php echo $p97; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p98" style="display:<?php echo $p98; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p99" style="display:<?php echo $p99; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p100" style="display:<?php echo $p100; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p101" style="display:<?php echo $p101; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p102" style="display:<?php echo $p102; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p103" style="display:<?php echo $p103; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p104" style="display:<?php echo $p104; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p105" style="display:<?php echo $p105; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p106" style="display:<?php echo $p106; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p107" style="display:<?php echo $p107; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p108" style="display:<?php echo $p108; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p109" style="display:<?php echo $p109; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p110" style="display:<?php echo $p110; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p111" style="display:<?php echo $p111; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p112" style="display:<?php echo $p112; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p113" style="display:<?php echo $p113; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p114" style="display:<?php echo $p114; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p115" style="display:<?php echo $p115; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p116" style="display:<?php echo $p116; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p117" style="display:<?php echo $p117; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p118" style="display:<?php echo $p118; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p119" style="display:<?php echo $p119; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p120" style="display:<?php echo $p120; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p121" style="display:<?php echo $p121; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p122" style="display:<?php echo $p122; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p123" style="display:<?php echo $p123; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p124" style="display:<?php echo $p124; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p125" style="display:<?php echo $p125; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p126" style="display:<?php echo $p126; ?>; "> 
        ...
        <tr>
            <td>
                <div id="p127" style="display:<?php echo $p127; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p128" style="display:<?php echo $p128; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p129" style="display:<?php echo $p129; ?>; ">
                    <table>    
                        <tr>
        ...
        <tr>
            <td>
                <div id="p130" style="display:<?php echo $p130; ?>; ">
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p131" style="display:<?php echo $p131; ?>; " > 
        ...
        <tr>
            <td>
                <div id="p132" style="display:<?php echo $p132; ?>; " >
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p133" style="display:<?php echo $p133; ?>; " >
                    <table>
                        <tr>
        ...
        <tr>
            <td>
                <div id="p134" style="display:<?php echo $p134; ?>; ">
                    <table>
                        <tr>
